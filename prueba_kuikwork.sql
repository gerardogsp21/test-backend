...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-06-2019 a las 04:22:35
...
(1, '2019_06_14_022914_create_marcas_table', 1),
(2, '2019_06_14_022955_create_productos_table', 2);
...
CREATE TABLE `productos` (
  `id` int(10) UNSIGNED NOT NULL,
  `nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `talla` enum('S','M','L') COLLATE utf8mb4_unicode_ci NOT NULL,
...
ALTER TABLE `marcas`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `marcas_referencia_unique` (`referencia`);
